...
# gwm <- read.table("Data/gw05month.txt", header=TRUE, sep="\t")
gwq <- read.table("Data/gw05quarter.txt", header=TRUE, sep="\t")
# gwa <- read.table("Data/gw05annual.txt", header=TRUE, sep="\t")

# gwm13 <- read.table("Data/gw13month.txt", header=TRUE, sep="\t")
# gwq13 <- read.table("Data/gw13quarter.txt", header=TRUE, sep="\t")
# gwa13 <- read.table("Data/gw13annual.txt", header=TRUE, sep="\t")
...
method <- 'CV'
plot.ts(cumsum(feval(y=e.ret,X=NULL,P=P)$sfe[,'Stable'])-cumsum(feval(y=e.ret,X=dy,P=P)$sfe[,method]),col=4,ylab="CSFE Diff",main=paste('dy',method));abline(h=0,col=2,lty=2)
plot.ts(cumsum(feval(y=e.ret,X=NULL,P=P)$sfe[,'Stable'])-cumsum(feval(y=e.ret,X=dp,P=P)$sfe[,method]),col=4,ylab="CSFE Diff",main=paste('dp',method));abline(h=0,col=2,lty=2)
plot.ts(cumsum(feval(y=e.ret,X=NULL,P=P)$sfe[,'Stable'])-cumsum(feval(y=e.ret,X=ep,P=P)$sfe[,method]),col=4,ylab="CSFE Diff",main=paste('ep',method));abline(h=0,col=2,lty=2)
plot.ts(cumsum(feval(y=e.ret,X=NULL,P=P)$sfe[,'Stable'])-cumsum(feval(y=e.ret,X=de,P=P)$sfe[,method]),col=4,ylab="CSFE Diff",main=paste('de',method));abline(h=0,col=2,lty=2)
plot.ts(cumsum(feval(y=e.ret,X=NULL,P=P)$sfe[,'Stable'])-cumsum(feval(y=e.ret,X=svar,P=P)$sfe[,method]),col=4,ylab="CSFE Diff",main=paste('svar',method));abline(h=0,col=2,lty=2)
plot.ts(cumsum(feval(y=e.ret,X=NULL,P=P)$sfe[,'Stable'])-cumsum(feval(y=e.ret,X=bm,P=P)$sfe[,method]),col=4,ylab="CSFE Diff",main=paste('bm',method));abline(h=0,col=2,lty=2)
plot.ts(cumsum(feval(y=e.ret,X=NULL,P=P)$sfe[,'Stable'])-cumsum(feval(y=e.ret,X=ntis,P=P)$sfe[,method]),col=4,ylab="CSFE Diff",main=paste('ntis',method));abline(h=0,col=2,lty=2)
plot.ts(cumsum(feval(y=e.ret,X=NULL,P=P)$sfe[,'Stable'])-cumsum(feval(y=e.ret,X=tbl,P=P)$sfe[,method]),col=4,ylab="CSFE Diff",main=paste('tbl',method));abline(h=0,col=2,lty=2)
plot.ts(cumsum(feval(y=e.ret,X=NULL,P=P)$sfe[,'Stable'])-cumsum(feval(y=e.ret,X=ltr,P=P)$sfe[,method]),col=4,ylab="CSFE Diff",main=paste('ltr',method));abline(h=0,col=2,lty=2)
plot.ts(cumsum(feval(y=e.ret,X=NULL,P=P)$sfe[,'Stable'])-cumsum(feval(y=e.ret,X=lty,P=P)$sfe[,method]),col=4,ylab="CSFE Diff",main=paste('lty',method));abline(h=0,col=2,lty=2)
plot.ts(cumsum(feval(y=e.ret,X=NULL,P=P)$sfe[,'Stable'])-cumsum(feval(y=e.ret,X=tms,P=P)$sfe[,method]),col=4,ylab="CSFE Diff",main=paste('tms',method));abline(h=0,col=2,lty=2)
plot.ts(cumsum(feval(y=e.ret,X=NULL,P=P)$sfe[,'Stable'])-cumsum(feval(y=e.ret,X=dfy,P=P)$sfe[,method]),col=4,ylab="CSFE Diff",main=paste('dfy',method));abline(h=0,col=2,lty=2)
plot.ts(cumsum(feval(y=e.ret,X=NULL,P=P)$sfe[,'Stable'])-cumsum(feval(y=e.ret,X=dfr,P=P)$sfe[,method]),col=4,ylab="CSFE Diff",main=paste('dfr',method));abline(h=0,col=2,lty=2)
plot.ts(cumsum(feval(y=e.ret,X=NULL,P=P)$sfe[,'Stable'])-cumsum(feval(y=e.ret,X=infl,P=P)$sfe[,method]),col=4,ylab="CSFE Diff",main=paste('infl',method));abline(h=0,col=2,lty=2)
...
plot.ts(cumsum(feval(y=e.ret,X=NULL,P=P)$sfe[,'Stable'])-cumsum(sfe.combo),col=4,ylab="CSFE Diff",main=paste('D-Combo',method));abline(h=0,col=2,lty=2)       
