...
plot.ts(ts(cumsum(benchmark)-cumsum(sfe.combo), start=c(1965,1), freq=4),col=4,ylim=c(-0.156, 0.156),xlab="", ylab="CDSFE",main=paste(method));abline(h=0,col=2,lty=2)       
...
plot.ts(ts(cumsum(benchmark)-cumsum(sfe.combo), start=c(1965,1), freq=4),col=4,ylim=c(-0.156, 0.156),xlab="", ylab="CDSFE",main=paste("DMSFE"));abline(h=0,col=2,lty=2)       
...
# 6.171  6.008  5.835  5.826  6.214  5.071 
